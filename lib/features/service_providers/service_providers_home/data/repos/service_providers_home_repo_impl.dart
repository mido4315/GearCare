...
import 'service_providers_home_repo.dart';

class ServiceProvidersHomeRepoImpl implements ServiceProvidersHomeRepo {
  final APIService apiService;

  ServiceProvidersHomeRepoImpl(this.apiService);
  ...
  Future<Either<Failure, List<OrderModel>>> getAllRepairOrders() async {
    try {
      ...
      var result = await apiService.get(
        headers: headers,
        path: "ServiceProvider/GetAllRepareOrderToAccept",
      );
  ...
  Future<Either<Failure, void>> handleOrderAction(
    ...
    try {
      ...
      await apiService.postFormData(
        headers: headers,
        path: "ServiceProvider/HandleOrderAction",
