...
import 'widgets/winch_handle_order_buttons.dart';

class WinchHomeView extends StatelessWidget {
  const WinchHomeView({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<WinchGetAllRepairOrdersCubit, WinchGetAllRepairOrdersState>(
        builder: (context, state) {
          if (state is WinchGetAllRepairOrdersLoading) {
            return const Center(child: CircularProgressIndicator());
          } else if (state is WinchGetAllRepairOrdersLoaded) {
          ...
          } else if (state is WinchGetAllRepairOrdersError) {
            return Center(
